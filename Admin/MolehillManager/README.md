...
**File > Business and invoice details** holds what is printed at the top of every invoice: your name, the "trading as" line, contact, e-mail, phone, website, address, bank details and payment terms - plus **Logo file**, which loads a .png (or .jpg/.gif/.svg, up to 400 KB) into the database so invoices carry it without needing the file again. Tick **Remove the logo** to print the business name instead.
